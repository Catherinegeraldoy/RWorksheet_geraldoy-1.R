...
#2a. seq(1, 3, by=0.2) # specify step size.Write the R script and its output. Describe the output.
seq (1,3, by=0.2) 
#2a.It increases its value by .2 until it reaches its maximum value at 3
...
#3c. Access all but the 4th and 12th element is notincluded. Write the R script and its output.
...
num4[c("first", "third")] 
num4 
#4a. The output displays only the "first" and "third" variables using array.
...
#8a. Create vectors according to the above table. Write the R scripts and its output.
...
PowerRanking
#8b. Modify the power ranking and pay of J.K. Rowling. Change power ranking to 15 and pay to 90. Write the R scripts and its output.
power_ranking[19] <- 15
power_ranking 
pay[19] <- 90
pay
...
library(readr)
geraldoy <-read.csv("geraldoy.csv")
...
#e The  Power Rank result was change to 10 to 20 elements.
...
num_vegetables
#10c What is the R script and its output?
addVegetables4 <- append(addVegetables, c("lettuce", "zucchini", "radish", "bell pepper"), after = 5)
addVegetables4
# [[1]]
# [1] "cabbage"
